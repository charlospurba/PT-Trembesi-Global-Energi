    ...
    <div class="flex min-h-screen">
      ...
      <div class="max-w-7xl mx-auto mt-6">
       ...
       <div class="flex justify-end items-center mb-6">
          <a href="{{ route('productmanager.formadd') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-colors ml-auto">
