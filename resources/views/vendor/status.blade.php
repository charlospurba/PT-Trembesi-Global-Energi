    ...
    <div>
      ...
      @elseif ($status === 'rejected')
        <div class="bg-yellow-100 text-yellow-800 p-4 rounded">
          ...
          Registration cannot be processed because your data does not meet the applicable requirements. Please check and adjust again.
        </div>
      @elseif ($status === 'approved')
        <div class="bg-green-100 text-green-800 p-4 rounded flex justify-between items-center">
          <div>
            <strong>Data Successfully Verified</strong><br>
            Your registration was successful. Please log in to begin using the application features.
          </div>
