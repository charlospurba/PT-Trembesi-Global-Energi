...
@section('content')
    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-red-50 to-rose-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <!-- Ganti bagian grid dengan struktur berikut -->
                ...
                <div class="p-3 flex-shrink-0">
                    <div class="thumbnail-gallery">
                        ...
                        @if(count($images) < 6)
                            ...
                            <div class="thumbnail-item opacity-50" style="background: linear-gradient(135deg, #f3f4f6 0%, #e5e7eb 100%);">
    ...
    <h2 class="text-lg font-semibold text-gray-900 mb-3">Product Information</h2>
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <div class="flex flex-col p-3 bg-white rounded-lg shadow-sm border border-gray-100">
                            ...
                            <span class="font-semibold text-gray-900 text-sm">{{ $product->Unit ?? '-' }} </span>
                        </div>
                        <div class="flex flex-col p-3 bg-white rounded-lg shadow-sm border border-gray-100">
                        ...
                        <div class="flex flex-col p-3 bg-white rounded-lg shadow-sm border border-gray-100">
                            ...
                            <span class="font-semibold text-gray-900 text-sm">{{ $product->Specification ?? '-' }}</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-4 mt-2">
                                <div class="flex items-center bg-yellow-50 px-3 py-2 rounded-full border border-yellow-200">
