    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div class="lg:col-span-1">
            ...
            <div class="mt-4">
                ...
                <p class="text-sm text-gray-600 flex items-center gap-2">
                    ...
                    Shipped from <span class="font-semibold">{{ $product->location ?? 'Location not available' }}</span>
                </p>
            </div>
        </div>
        ...
        <div>
            <div class="border border-red-300 rounded-lg p-4 bg-red-50 shadow">
                ...
                <p class="text-xs mt-1 text-gray-600">Stock: {{ $product->stock ?? '-' }}</p>
                ...
                <div class="mt-3 flex gap-2">
                    <a href="/cart" class="bg-red-600 text-white w-full py-2 text-center rounded hover:bg-red-700">
                        Add to Cart
                    </a>
                    <a href="/cart" class="border border-red-600 text-red-600 w-full py-2 text-center rounded hover:bg-red-100">
                        Buy Now
                    </a>
                </div>
            </div>
