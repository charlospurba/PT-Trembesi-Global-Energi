        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            @forelse($products as $product)
                <a href="{{ route('product.detail', $product->id) }}" class="block">
                    <div
                        class="bg-white rounded-xl shadow-md overflow-hidden max-w-[300px] sm:max-w-[340px] w-full transition-transform hover:scale-105 duration-200">
                        ...
                        <div class="p-4">
                            <!-- Supplier -->
                            <span
                                class="inline-flex items-center px-2 py-1 text-xs font-medium bg-gray-200 text-gray-800 rounded-full mb-2">
                                {{ $product->supplier }}
                            </span>
                            <!-- Name -->
