    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-red-50 to-rose-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <nav class="flex items-center space-x-2 text-xs mb-4 glass-effect px-4 py-2 rounded-xl shadow-lg">
                ...
                <span class="text-red-600 font-semibold">PPE</span>
            </nav>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 mb-8 border-l-4 border-red-600">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-4xl font-bold text-gray-800 mb-1">PPE Collection</h1>
                            <p class="text-gray-600">Personal protective equipment for maximum protection</p>
                        </div>
                    </div>
                ...
                @empty
                    <div class="col-span-full">
                        <div class="bg-white rounded-lg shadow-sm p-8 text-center">
                            ...
                            <p class="text-sm text-gray-500 mb-3">There are currently no PPE products available.</p>
                        </div>
                    </div>
                @endforelse
            </div>
