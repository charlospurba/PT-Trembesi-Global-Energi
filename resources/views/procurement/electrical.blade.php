    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-red-50 to-rose-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <nav class="flex items-center space-x-2 text-xs mb-4 glass-effect px-4 py-2 rounded-xl shadow-lg">
                ...
                <a href="{{ route('procurement.electrical') }}"><span
                        class="text-red-600 font-semibold">Electrical</span></a>
            </nav>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Discover the best electrical equipment for your needs</p>
                        </div>
                    </div>
            ...
            <!-- Filter Section -->
            <form method="GET" action="{{ route('procurement.electrical') }}" class="bg-white rounded-lg shadow-sm p-3 mb-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                @forelse($products as $product)
                    <a href="{{ route('product.detail', $product->id) }}" class="block group">
                        <div
                            class="bg-white rounded-lg overflow-hidden max-w-[250px] w-full transition-all duration-300 hover:shadow-[0_4px_12px_rgba(220,38,38,0.4)] hover:-translate-y-1 border border-gray-100">
                            <div
                            ...
                            <div class="p-3 space-y-2">
                                ...
                                <!-- Product Name -->
                                <h3
                                    class="text-sm font-semibold text-red-600 line-clamp-2 leading-tight group-hover:text-red-700 transition-colors">
                                    {{ $product->name }}
                                </h3>

                                <div class="flex items-center justify-between">
                                    <span class="text-base font-bold text-red-600">
                                        IDR {{ number_format($product->price ?? 0, 0, ',', '.') }}
                                    </span>
                                </div>
                                ...
                                <div class="flex items-center text-xs text-gray-600 bg-gray-50 p-2 rounded-lg">
                                    ...
                                    <span class="truncate">{{ $product->address ?? 'Location not available' }}</span>
                                </div>
                ...
                @empty
                    <div class="col-span-full">
                        <div class="bg-white rounded-lg shadow-sm p-8 text-center">
                            ...
                            <p class="text-sm text-gray-500 mb-3">There are currently no electrical products available.</p>
                        </div>
                    </div>
                @endforelse
            </div>
