...
@section('content')
    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-red-50 to-rose-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <nav class="flex items-center space-x-2 text-xs mb-4 glass-effect px-4 py-2 rounded-xl shadow-lg">
                ...
                <a href="{{ route('procurement.equipment') }}">
                    <span class="text-red-600 font-semibold">Equipment</span>
                </a>
            </nav>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 mb-8 border-l-4 border-red-600">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-4xl font-bold text-gray-800 mb-1">Equipment Collection</h1>
                            <p class="text-gray-600">Discover high-quality equipment for your needs</p>
                        </div>
                    </div>
            ...
            <!-- Filter -->
            <form method="GET" action="{{ route('procurement.equipment') }}" class="bg-white rounded-lg shadow-sm p-3 mb-6">
    ...
    {{ $product->name }}
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    @endphp
                                    <span class="text-xs font-semibold {{ $stockClass }}">{{ $quantity }}</span>
                                </div>
                            </div>
                        </div>
                    </a>
                @empty
                    <div class="col-span-full">
                        <div class="bg-white rounded-lg shadow-sm p-8 text-center">
                            ...
                            <p class="text-sm text-gray-500">There are currently no equipment products available.</p>
                        </div>
                    </div>
                @endforelse
            </div>
