    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-red-50 to-rose-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <nav class="flex items-center space-x-2 text-xs mb-4 glass-effect px-4 py-2 rounded-xl shadow-lg">
                ...
                <a href="{{ route('procurement.consumables', ['note_id' => $note_id ?? null]) }}"><span
                        class="text-red-600 font-semibold">Consumables</span></a>
            </nav>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Consumable items ready to support your project</p>
                        </div>
                    </div>
            ...
            <form method="GET" action="{{ route('procurement.consumables') }}"
                ...
                @empty
                    <div class="col-span-full">
                        <div class="bg-white rounded-lg shadow-sm p-8 text-center">
                            ...
                            <p class="text-sm text-gray-500 mb-3">There are currently no consumable products available.</p>
                        </div>
                    </div>
                @endforelse
            </div>
