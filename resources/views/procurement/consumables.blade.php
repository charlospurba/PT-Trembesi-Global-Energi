...
@section('content')
    ...
    <div class="bg-gray-50 py-8">
        <div class="collection max-w-7xl mx-auto px-4">
            <!-- Judul Halaman -->
            <div class="flex items-center gap-3 mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-800">Koleksi Consumables</h1>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                @forelse($products as $product)
                    <a href="{{ route('product.detail', $product->id) }}" class="block">
                        <div class="bg-white rounded-xl shadow-md overflow-hidden max-w-[300px] sm:max-w-[340px] w-full transition-transform hover:scale-105 duration-200">
                            <!-- Gambar Produk -->
                            <div class="bg-red-600 p-4 flex justify-center items-center h-40">
                            ...
                            <div class="p-4 space-y-2 text-sm">
                                <!-- Supplier -->
                                <span class="inline-flex items-center px-2 py-1 text-xs font-medium bg-gray-200 text-gray-800 rounded-full">
                                    {{ $product->supplier }}
                                </span>
                ...
                @empty
                    <p class="col-span-4 text-center text-gray-500">Tidak ada produk kategori Electrical.</p>
                @endforelse
            </div>
        </div>
    </div>
