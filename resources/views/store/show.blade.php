    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-red-50 to-rose-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <nav class="flex items-center space-x-2 text-xs mb-4 glass-effect px-4 py-2 rounded-xl shadow-lg">
                ...
                <a href="{{ route('procurement.material') }}" class="text-gray-600 hover:text-red-600 transition-all duration-300">Material</a>
                <i class="fas fa-chevron-right text-gray-400 text-xs"></i>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 mb-8 border-l-4 border-red-600">
                <div class="flex flex-col md:flex-row items-center gap-6">
                    ...
                    @endphp
                    <div class="w-24 h-24 bg-gradient-to-r from-red-600 to-red-700 rounded-2xl overflow-hidden shadow-lg border-4 border-white">
                    ...
                    <div class="flex-1 text-center md:text-left">
                        ...
                        <div class="flex flex-wrap justify-center md:justify-start items-center gap-4 text-sm">
                            <div class="flex items-center bg-yellow-50 px-3 py-1 rounded-full">
                                ...
                                <span class="font-medium text-gray-700">{{ $averageRating }} ({{ $totalReviews }} reviews)</span>
                            </div>
                            ...
                            <div class="flex items-center bg-green-50 px-3 py-1 rounded-full">
                                ...
                                <span class="font-medium text-gray-700">Active Store</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    ...
                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                        ...
                        <div class="flex items-center gap-2 bg-gray-100 px-4 py-2 rounded-full">
                            ...
                            <span class="text-sm text-gray-600 font-medium">{{ $products->total() }} Products Available</span>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="p-2 space-y-1">
                                    ...
                                    @if($product->description)
                                        <div class="flex items-start text-xs text-gray-600">
                                            ...
                                            <span class="line-clamp-1 text-xs">{{ Str::limit($product->description, 30) }}</span>
                                        </div>
                                    @endif
                                ...
                                <div class="hidden sm:block">
                                    <div class="flex flex-col lg:flex-row items-center justify-between space-y-4 lg:space-y-0">
                                        ...
                                        <div class="text-sm text-gray-600">
                                            Showing <span class="font-medium text-red-600">{{ $products->firstItem() }}</span> to 
                                        ...
                                        <div class="flex items-center space-x-1">
                                            ...
                                            {{-- Previous Page --}}
                                            @if ($products->onFirstPage())
                                                <span class="px-3 py-2 text-sm bg-gray-50 text-gray-400 rounded-lg cursor-not-allowed border border-gray-200 flex items-center">
                                            ...
                                            @for ($i = $start; $i <= $end; $i++)
                                                @if ($i == $products->currentPage())
                                                    <span class="px-4 py-2 text-sm bg-red-600 text-white rounded-lg font-medium shadow-md border border-red-600 relative">
                                                        {{ $i }}
                ...
                <div class="col-span-full">
                    <div class="bg-white rounded-xl shadow-lg p-12 text-center border border-gray-100">
                        ...
                        <p class="text-gray-500 mb-8 max-w-md mx-auto leading-relaxed">
                            This store doesn't have any products available at the moment. Check back later or browse other materials from our trusted suppliers.
                        </p>
