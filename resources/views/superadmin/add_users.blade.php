                    ...
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            <li class="inline-flex items-center">
                                <a href="{{ route('superadmin.dashboard') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 transition-colors">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="group">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" 
                                    class="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-gray-700 
                                           focus:border-blue-500 focus:ring-0 transition-all duration-200 
                                           group-hover:border-gray-300 focus:shadow-lg focus:shadow-blue-500/20" 
                            ...
                            <div class="group">
                                ...
                                <select name="role" 
                                    ...
                                    <option value="procurement" {{ old('role') === 'procurement' ? 'selected' : '' }}>
                                        Procurement
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="flex flex-col sm:flex-row justify-end gap-3 pt-6 mt-6 border-t border-gray-200">
                            ...
                            <button type="submit"
                                class="inline-flex items-center justify-center px-5 py-2 bg-gradient-to-r 
                                       ...
                                       focus:ring-blue-500 focus:ring-offset-2 transform hover:scale-105">
